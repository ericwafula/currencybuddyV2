...
data class ConverterState(
    ...
    val baseFlagUrlPng: String = "",
    val baseFlagUrlSvg: String = "",
    val quoteFlagUrlPng: String = "",
    val quoteFlagUrlSvg: String = "",
    ...
    val isBaseCurrencyToggled: Boolean = false,
    val isQuoteCurrencyToggled: Boolean = false,
